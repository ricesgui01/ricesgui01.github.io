...
//完成form表单数据的提交
 $("#btn").click(function(){
  ...
  var adoptres=$("input[name='adoptres']").val();
  $.ajax({
  type:'POST',  
  url:"/views/send_placeout",
  contentType: "application/json; charset=utf-8",
  data:JSON.stringify({"pet":{"petspecies":petspecies,"name":name,"sex":sex,"age_year":age_year,"age_month":age_month,"weight":weight,"petdescri":petdescri,"petphotourl":petphotourl},"placeout":{"placeouttitle":placeouttitle,"datetime":datetime,"realname":realname,"number":number,"address":address,"adoptres":adoptres}}),
  dataType:"json",
